...
//    composition
    ...
    public computer(long id, microprocesseur microprocess, Screen screen, Provider provider, String battery, double price, int RAM, int hardDisk, ProductState state) {
        this.id = id;
